...
|---|---|---|---|---|---|---|
| API-01 | API | AC-01 | Create valid ticket | 201; one saved Ticket; number returned | server/tests/lab-02/create-ticket.api.test.ts | |
...
- [ ] Desktop layout uses multi-column for Create Ticket
- [ ] Mobile layout stacks fields vertically
- [ ] No clipped labels, overlapping messages, or horizontal scrolling on mobile
- [ ] Buttons use Zen Green Primary/Secondary styling correctly
- [ ] Disabled buttons visually distinct and inaccessible
- [ ] Validation messages appear immediately below the field
...
## 6. Final Results
*(To be populated during the development and fixing phases)*
